...
-- Add fields to support message summarization for context window management

-- Add summary flag to mark summary messages
ALTER TABLE aichat_messages ADD COLUMN is_summary INTEGER NOT NULL DEFAULT 0;

-- Add JSON array of message IDs that this summary replaces
